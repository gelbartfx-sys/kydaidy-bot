...
_BASE_TEXTS = {
    "manifest_7": (
        ...
        "Что внутри:\n"
        "• PDF-воркбук на 80 страниц + колода «Карта перепутья» — в закрытом канале\n"
        "• 7 практик с проводником — прямо здесь, в боте: команда /praktiki. "
        "Я веду шаг за шагом, темп задаёшь ты\n\n"
