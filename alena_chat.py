...
_PEAK_HOLD_VOICE = (
    "Я всё ещё здесь, рядом с тем, что у тебя поднялось. Сейчас твой мозг делает "
    "редкую вещь — перезаписывает старую запись, и ему для этого нужна тишина, а не "
    "мои вопросы. Не тороплю. Когда захочешь дальше — скажи, и пойдём оттуда, где "
    "остановились.")
_PEAK_HOLD_TEXT = (
    "Я всё ещё здесь, рядом с тем, что поднялось 🕯 Мозг сейчас перезаписывает "
    "старую запись — ему нужна тишина, не вопросы. Не тороплю. Захочешь дальше — "
    "скажи, и пойдём оттуда, где остановились.\n\n— Алёна")
...
_GATED_WARM_TEXT = (
    "Сегодня ты сделала важное — увидела, куда на самом деле тянет. Сейчас мозгу "
    "нужно время уложить это — он дописывает такое ночью, во сне, без нашего участия. "
    "Поэтому не тороплю ни на шаг. Я рядом каждый день в канале — заходи, когда "
    "захочется. А захочешь пойти дальше — просто напиши, и продолжим оттуда, где "
    "остановились.")
...
def _door_choice_line(door: str, u_row) -> str:
    ...
    try:
        ...
        tag = ""
    # Тексты v2 (Кай 12.07): с нейромеханизмом простыми словами (мозг/дорожка/
    # нервная система), без терминов. Черновик — финальный тон правит Алёна.
    if door == "one_on_one":
        colour = (f"ты — та, {tag}: " if tag else "")
        return (
            "Дальше — две двери, и скажу честно, к какой тебя тянет. Есть круг — "
            f"женщины рядом, общий ритм. Но {colour}в любой группе твой мозг занят "
            "не собой, а обороной — следит за чужими глазами и правилами, и на "
            "настоящую работу сил уже не остаётся. Наедине эта охрана выключается: "
            "всё внимание — на тебя и твою дорожку, ни грамма на держать лицо. "
            "Тебе, кажется, ближе так — только ты и я. Хотя если захочется сперва "
            "побыть среди своих — круг открыт. Сейчас покажу обе, выберешь сама.")
    return (
        ...
        "У мозга есть древняя настройка: среди своих он выключает сирену тревоги сам, "
        "без усилий — просто оттого, что рядом те, кому не надо ничего доказывать. "
        "Ты столько держала лицо, что твоя нервная система забыла, как это — не быть "
        "начеку. По тому, что сегодня открылось, тебе, кажется, нужнее сперва круг — "
        "место, где мозг наконец разожмёт кулак. Но выбор твой, сейчас покажу обе.")
